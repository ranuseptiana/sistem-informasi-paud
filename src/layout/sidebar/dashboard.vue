...
@media (min-width: 361px) and (max-width: 480px) {
    ...
    .card-information, .dashboard-grid {
        display: flex;
        flex-wrap: nowrap; /* Memastikan kartu tetap dalam satu baris */
        overflow-x: auto; /* Mengaktifkan scroll horizontal jika diperlukan */
        -webkit-overflow-scrolling: touch; /* Memberikan efek scroll yang halus di perangkat mobile */
        gap: 10px;
    }
    .card-dashboard, .card-dashboard-1 {
        min-width: 220px; /* Pastikan kartu memiliki ukuran minimum */
        flex-shrink: 0; /* Mencegah kartu mengecil terlalu kecil */
    }
    .chart-menu {
        display: flex;
        flex-direction: column;
