    ...
    <nav aria-label="breadcrumb">
        ...
        <div>
            <div class="list-peserta">
                ...
                <p style="margin-top: 10px;"><strong>Guru Pengajar:</strong> {{ waliKelas.nama_lengkap }}</p>
            </div>
            ...
            <div class="pagination-info-siswa-kelas">
    ...
    methods: {
        async login() {
            try {
                ...
                const siswaId = response.data.siswaId;

                localStorage.setItem("auth_token", response.data.token);
                localStorage.setItem("id_siswa", response.data.siswaId);

                let userId = localsStorage.getItem("id_siswa");

                this.fetchKelasBySiswaId();
            } catch (error) {
        ...
        async fetchKelasBySiswaId(id) {
            try {
                ...
                onsole.error("Gagal mengambil data kelas:", error.response ? error.response.data : error.message);
            }
        },
